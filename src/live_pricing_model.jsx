...
function FunnelViz({ counts, dollars, isrInProgram, totalClientSpend, economics, term, dense = false }) {
  ...
  countStages.forEach((s, ci) => {
    ...
    if (ci === dealsIdx) {
      funnelBars.push({ kind: "dollar", label: "Won revenue", role: "REALIZED", color: GREEN, value: wonRev });
    }
  });
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1px 1fr", gap: 20, alignItems: "stretch" }}>
        ...
        <div>
          ...
          {funnelBars.map((s, i) => {
            ...
            const w = isDollar ? dollarWidthOf(s.value) : widthOf(s.value);
            ...
            return (
              <div key={i} style={{ marginBottom: BAR_GAP }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  {/* Stage conversion % (count stages only) */}
