...
// ─────────────────────────────────────────────────────────────────────────────
// PDF — produced via the browser's native print path (window.print()).
// The print layout lives in the <ProposalPrint> component; this helper just
// builds the header subtitle shared by that layout.
// ─────────────────────────────────────────────────────────────────────────────

// Descriptive subtitle for the proposal header. Rep roles appear only when
// configured (with a plural "s" past 1); "layered management" and "technology
// stack" are always included per the proposal template.
export function proposalSubtitle(inputs) {
